...
namespace DiversityService
{
    public static class ModelProjection
    {
        ...
        public static DB.CollectionSpecimen ToEntity(this Model.Specimen spec)
        {
            ...
            export.CollectionEventID = spec.DiversityCollectionEventID;
            export.DepositorsAccessionNumber = spec.AccessionNumber;
            export.Version = 1;
            return export;
        }
        ...
        public static IList<DB.IdentificationUnitGeoAnalysis> ToGeoAnalyses(this IList<Model.IdentificationUnit> unitList, Model.UserCredentials profile)
        {
            List<DB.IdentificationUnitGeoAnalysis> exportList = new List<DB.IdentificationUnitGeoAnalysis>();
            foreach (Model.IdentificationUnit iu in unitList)
            {

...
namespace DiversityPhone.Services
{
    public partial class FieldDataService : IFieldDataService, IKeyMappingService, IEnableLogger
    {
        ...
        #endregion CollectionEventProperties
        ...
        #endregion Generische Implementierungen
        ...
        private static IDictionary<Type, Delegate> keyComparerFactories = new Dictionary<Type, Delegate>();

        private Expression<Func<T, bool>> getKeyComparison<T, TKey>(TKey id)
        {

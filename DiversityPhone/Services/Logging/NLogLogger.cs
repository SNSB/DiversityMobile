...
namespace ReactiveUI.NLog
{
    public class NLogLogger : IRxUIFullLogger
    {
        ...
        public virtual void DebugException(string message, Exception exception)
        {
        ...
        public virtual void InfoException(string message, Exception exception)
        {
        ...
        public virtual void WarnException(string message, Exception exception)
        {
        ...
        public virtual void FatalException(string message, Exception exception)
        {

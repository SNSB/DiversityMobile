...
namespace DiversityService.Test.ServiceReference {
    ...
    public interface IDiversityService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDiversityService/DownloadPropertyList", ReplyAction="http://tempuri.org/IDiversityService/DownloadPropertyListResponse")]
        DiversityService.Test.ServiceReference.PropertyName[] DownloadPropertyList(string list);
        ...
        System.Collections.Generic.Dictionary<int, int> InsertEventSeries(DiversityService.Test.ServiceReference.EventSeries[] series);
    ...
    public partial class DiversityServiceClient : System.ServiceModel.ClientBase<DiversityService.Test.ServiceReference.IDiversityService>, DiversityService.Test.ServiceReference.IDiversityService {
        ...
        public string[] GetAvailablePropertyLists() {
            return base.Channel.GetAvailablePropertyLists();
        }
        
        public DiversityService.Test.ServiceReference.PropertyName[] DownloadPropertyList(string list) {
            return base.Channel.DownloadPropertyList(list);
        }
        
        public System.Collections.Generic.Dictionary<int, int> InsertEventSeries(DiversityService.Test.ServiceReference.EventSeries[] series) {
            return base.Channel.InsertEventSeries(series);
        }
        
        public void InsertGeographyIntoSeries(int seriesID, string geostring) {
            base.Channel.InsertGeographyIntoSeries(seriesID, geostring);
        }
